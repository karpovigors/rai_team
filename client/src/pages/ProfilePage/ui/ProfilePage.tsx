    ...
    <div className="auth-page">
      ...
      <main className="auth-main">
        ...
        <section className="push-section learning-section">
          <h3>Обучение и развитие коммуникационных навыков</h3>
          <p className="push-hint">
            Полезные материалы и рекомендации для развития коммуникации, ориентации в городе
            и взаимодействия с доступной средой.
          </p>
